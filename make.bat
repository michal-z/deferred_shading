...
cl /Zi /Od /Gm- /nologo /WX /D_CRT_SECURE_NO_WARNINGS /W3 /GS- /Gs999999 /Gy /Gw /EHa- eneida.cpp ^
   /link eneida_asmlib.obj d3d12.lib dxgi.lib dxguid.lib ole32.lib avrt.lib kernel32.lib user32.lib gdi32.lib ^
