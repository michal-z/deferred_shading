...
void *
operator new[](size_t size, const char* /*name*/, int /*flags*/,
...
void *
operator new[](size_t size, size_t alignment, size_t alignmentOffset, const char* /*name*/,
